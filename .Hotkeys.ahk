...
scripthotkeys["Miscellaneous"] := []
 ...
 scripthotkeys["Miscellaneous"].push("League of Legends", ["Player Attack Move Click", "F13", "{F13}"], ["Dance", "F14", "{F14}"], ["Joke", "F15", "{F15}"], ["Taunt", "F16", "{F16}"], ["Laugh", "F17", "{F17}"], ["Mastery", "F18", "{F18}"], ["Fist Bump", "F19", "{F19}"], -1)
 scripthotkeys["Miscellaneous"].push("Minecraft", ["Swing Sword and Eat Food", "Alt+1", "!1"], ["Hold Shift", "Alt+Shift", "!{Shift}"], -1)
 scripthotkeys["Miscellaneous"].push("R.E.P.O.", ["Happy", "F13", "{F13}"], ["Crazy", "F14", "{F14}"], ["Angry", "F15", "{F15}"], ["Suspicious", "F16", "{F16}"], ["Sad", "F17", "{F17}"], ["Eyes Closed", "F18", "{F18}"], -1)
...
TraySetIcon('.Hotkeys\.Hotkeys.png',, true)
